      ...
      <div className="col-span-12 xl:col-span-6 h-full">
        <Card className="p-0 ring-0 border rounded-2xl relative h-full">
          <CardContent className="p-0">
            ...
            {/* decorative gradient (was a remote template image) */}
            <div className="pointer-events-none absolute bottom-0 right-0 hidden h-40 w-52 rounded-tl-[40px] bg-gradient-to-tl from-blue-500/15 to-transparent sm:block" />
          </CardContent>
        </Card>
      </div>
