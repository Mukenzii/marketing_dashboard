...
export const uz = {
  ...
  users: {
    ...
    fRole: "Rol",
    inviteTitle: "Foydalanuvchini taklif qilish",
    inviteDesc:
      "Yangi foydalanuvchi ma'lumotlarini kiriting. Parol o'rnatish havolasi serverda yaratiladi.",
    fName: "Ism",
    fEmail: "Email",
    inviteSuccess: "Taklif yaratildi. Havola server logiga yozildi.",
    save: "Saqlash",
    saving: "Saqlanmoqda…",
  ...
  results: {
    ...
    note: "Lidga asoslangan ko'rsatkichlar (CPL, Lidlar, Tashrif darajasi, Lid darajasi) ThruPlay uchun optimallashtirilgan kampaniyalarda 0 bo'ladi.",
